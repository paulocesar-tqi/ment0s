				...
				<tr>
					<td>
						<display:table style="width:90%" name="sessionScope._DISPLAY_TAG_SPACE_1" pagesize="20" id="repasses" requestURI="/scc/user/relatorio/chamadas/credito/tab1.scc" class="ui-state-default">
							...
							<display:column property="dtCredito" title="Data Crédito"/>
							<display:column property="valorCredito" title="Valor Crédito" />
							<display:column property="nuCDR" title="Nu Cdr" />
							<display:column property="cdCredito" title="Código Crédito" />
							<display:column property="nuAssA" title="Número de A" />
							<display:column property="nuAssB" title="Número de B" />
