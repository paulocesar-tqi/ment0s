...
<td><form:select path="entity.id.cdStatusDe" id="cdStatusDe" itemValue="cdStatusCdr" itemLabel="detalhes" items="${listaStatusEdicao}"/>
	<form:input path="" id="cdStatusDeEdit" style="display: none;" size="60"/>
</td>
</tr>

<tr>
<td width="15%">Status Para:</td>
<td><form:select path="entity.id.cdStatusPara" id="cdStatusPara" itemValue="cdStatusCdr" itemLabel="detalhes" items="${listaStatusEdicao}"/>
	<form:input path="" id="cdStatusParaEdit" style="display: none;" size="60"/>
</td>
</tr>

<tr>
<td width="15%">Data Início:</td>
<td> <form:input path="entity.id.dtInicioVigencia" id="dtInicioVigencia"/>
...
$(function() {
	...
	if (op == 'CRUD.editar') {
		...
		$('#cdStatusDeEdit').val($('#cdStatusDe :selected').text());
		$('#cdStatusParaEdit').val($('#cdStatusPara :selected').text());

		$('#cdStatusDeEdit').show();		
		$('#cdStatusParaEdit').show();
		
		$('#cdStatusDeEdit').attr('disabled', 'disabled');
		$('#cdStatusParaEdit').attr('disabled', 'disabled');
