...
$('#sumarioStatusTable').dataTable( {
	"aoColumns" : [{"fnRender": function(oObj,val)
        {	
			var cdStatus = oObj.aData[0];
			return "<a href=/scc/user/pos/processados/sumario/data/cdStatus/"+cdStatus+".scc>"+cdStatus+"</>";
        }},null,null],
	"oLanguage" : {
		"sSearch" : "Filtro:",
	...
	"bProcessing": true,
	"bJQueryUI": true,
	"sAjaxSource": '/scc/user/pos/processados/sumario/status/table/json.scc',
...
<div id="tabs-1">
<form:form  method="GET" action="/scc/user/pos/processados/pesquisa/back.scc" id="form1">
<table  width="100%" border="0" cellspacing="0" cellpadding="0" >
<tr><td>
<table  id="sumarioStatusTable" width="100%" border="1" cellspacing="0" cellpadding="0" >
<thead> 
<tr>
<th><spring:message code="pesquisa_processados_pos.sumario.status.cdStatus"/></th>
<th><spring:message code="pesquisa_processados_pos.sumario.status.dsStatus"/></th>
<th><spring:message code="pesquisa_processados_pos.sumario.status.qtCdrs"/></th>
</tr>
</thead>
<tbody>
<td></td>
