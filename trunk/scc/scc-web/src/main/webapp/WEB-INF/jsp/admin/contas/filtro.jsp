...
<table  width="100%" border="0" cellspacing="0" cellpadding="0" >
 <tr><td>                            
<display:table style="width:90%"  name="sessionScope._DISPLAY_TAG_SPACE_1"   pagesize="20"  id="repasses" requestURI="/scc/user/admin/contas/tab1.scc" class="ui-state-default">
<display:column property="row.cdConta" title="Número da Conta" />
<display:column property="row.dsConta" title="Nome da Conta" />
<display:column property="tpCentro" title="Conta Cadastrada" />
<display:column property="statusConta" title="Status" />
...
<td><form:input path="entity.cdConta" id="cdConta" size="10" maxlength="11"/><form:errors path="entity.cdConta"/></td>
</tr>

<tr>
<td width="15%">Nome:</td>
<td><form:input path="entity.dsConta" id="dsConta" size="61" maxlength="60"/><form:errors path="entity.cdConta"/></td>
</tr>

<tr>
<td width="15%">Status:</td>
<td>
<form:select path="entity.inStatusConta"  itemValue="key" itemLabel="label" items="${status}"/></td>
</tr>


<tr>
<td width="15%">Centro:</td>
<td><form:select path="entity.tpCentro" itemValue="key" itemLabel="label" items="${centro}"/></td>
</tr>
...
$(function() {
	...
	if (op == 'CRUD.editar') {
		...
		$('#atualizar_button').show();
		//$('#cdConta').attr('disabled', 'disabled');		
		$('#cdConta').show();
