...
<tr>
<td width="15%">Tipo:</td>
<td> <form:select path="tpDominio" id="filtro_tpDominio" itemValue="key" itemLabel="label" items="${tipos}"/></td>
</tr>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
...
<table  width="100%" border="0" cellspacing="0" cellpadding="0" >
 <tr><td>                            
<display:table style="width:90%"  name="sessionScope._DISPLAY_TAG_SPACE_1"   pagesize="20"  id="repasses" requestURI="/scc/user/admin/dominio/tab1.scc" class="ui-state-default">
<display:column property="row.id.cdDominio" title="Codigo" />
<display:column property="row.dsDominio" title="Descrição" />
<display:column property="row.id.tpDominio" title="Tipo" />
...
<td><form:input path="entity.id.cdDominio" size="5" id="cdDominio" maxlength="4"/> <form:errors path="entity.id.cdDominio"/> </td>
</tr>

<tr>
<td width="15%">Descrição:</td>
<td> <form:input path="entity.dsDominio" size="21" maxlength="20"/> <form:errors path="entity.dsDominio"/> </td>
</tr>

<tr>
<td width="15%">Tipo:</td>
<td> <form:select path="entity.id.tpDominio" id="tpDominio" itemValue="key" itemLabel="label" items="${tipos}"/></td>
</tr>
...
$(function() {
	...
	if (op == 'CRUD.editar') {
		...
		$('#atualizar_button').show();
		$('#cdDominio').attr('disabled', 'disabled');
		$('#tpDominio').attr('disabled', 'disabled');
