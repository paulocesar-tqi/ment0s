...
<link rel="stylesheet" href="/scc/css/jquery-ui.css" type="text/css"/>
 ...
 <script type="text/javascript" src="<c:url value="/js/jquery.tmplPlus.js"/>"></script>
  <script type="text/javascript" src="<c:url value="/js/scc/indicadorpre.js"/>"></script>
...
<div id="tabs">
	...
	<form:form modelAttribute="filtro" method="post" action="/scc/user/indicador/indicador/pre/listar.scc" id="form1">
				...
				<tr>
					<td>
						...
						<display:table style="width:90%" name="requestScope.filtro.listIndicador" pagesize="20" 
									   id="repasses" 
									   requestURI="${pageContext.request.contextPath}/user/indicador/indicador/pre/listar.scc"
									   class="ui-state-default" 
									   decorator="com.claro.sccweb.decorator.view.SccIndicadorDecorator">
							<display:column property="cdTipoContrato"  class="edit_indicadores" href="editarIndicador.scc?indicador=${repasses.cdIndicador}" title="Tipo"/>
							<display:column property="cdIndicador" href="editarIndicador.scc?indicador=${repasses.cdIndicador}" title="Indicador"/>
							<display:column property="dsIndicador" href="editarIndicador.scc?indicador=${repasses.cdIndicador}" title="Descrição"/>
							<display:column property="dsFormatoIndicador" href="editarIndicador.scc?indicador=${repasses.cdIndicador}" title="Formato"/>
		...
		<div id="tabs-2" style="height: 500px;">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="tbledit" >
				...
				<tr>
					...
					<td><form:input path="entidade.cdDwlind" id="cdDwlind" /></td>
				</tr>
				...
				<tr>
					...
					<tr>
						...
						<td><form:input path="entidade.dtReferencia" id="dtReferencia" cssClass="datepicker"/></td>
					</tr>
