...
<table  width="100%" border="0" cellspacing="0" cellpadding="0" >
 <tr><td>                            
<display:table style="width:90%"  name="sessionScope._DISPLAY_TAG_SPACE_1"   pagesize="20"  id="repasses" requestURI="/scc/user/admin/email/tab1.scc" class="ui-state-default">
<display:column property="row.descricao" title="E-mail" />
...
<tr>
<td width="15%"><spring:message code="admin.label.email"/></td>
