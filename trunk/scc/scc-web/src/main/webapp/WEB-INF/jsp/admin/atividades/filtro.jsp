...
<table  width="100%" border="0" cellspacing="0" cellpadding="0" >
 <tr><td>                            
<display:table style="width:90%"  name="sessionScope._DISPLAY_TAG_SPACE_1"   pagesize="20"  id="repasses" requestURI="/scc/user/admin/atividade/tab1.scc" class="ui-state-default">
<display:column property="row.dsAtividadeContabil" title="Descrição" />
<display:column property="row.dominioContabil.dsDominioContabil" title="Domínio" />
<display:column property="row.contaCredito.dsConta" title="Conta Crédito" />
...
<form:hidden path="entity.sqAtividade" id="sqAtividade"/>
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
<tr><td width="15%">Domínio:</td>
<td><form:select path="entity.dominioContabil.cdDominioContabil" itemValue="cdDominioContabil" itemLabel="dsDominioContabil" items="${dominio}"/></td>
</tr>
...
<td><form:input path="entity.dsAtividadeContabil" size="50" maxlength="51"/><form:errors path="entity.dsAtividadeContabil"/></td>
</tr>

<tr><td width="15%">Conta Crédito:</td>
<td><form:select path="entity.contaCredito.cdConta" items="${contas}" itemValue="cdConta" itemLabel="dsConta"/></td>
</tr>

<tr><td width="15%">Conta Débito:</td>
<td><form:select path="entity.contaDebito.cdConta" items="${contas}" itemValue="cdConta" itemLabel="dsConta" /></td>
</tr>

<tr><td width="15%">Histórico Atividade:</td>
<td><form:textarea path="entity.txHistoricoAtividade" cols="100" /></td>
</tr>

<tr>
    <td width="10%">Data Expiração:</td>
    <td><form:input id="dtExpiracao" path="entity.dtExpiracao" />
    <form:errors path="entity.dtExpiracao" /></td>
</tr>
