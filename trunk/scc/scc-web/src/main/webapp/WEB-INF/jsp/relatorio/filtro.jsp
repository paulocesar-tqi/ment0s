...
<div id="tabs">
	...
	<form:form modelAttribute="filtro" method="post" action="/scc/user/relatorio/processo/parametro/execute.scc" id="form1">
		<form:hidden path="operacao" id="operacao" />
		
		<div id="tabs-1">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="filtroPesquisaTable">
				<tr>
					<td width="15%"><spring:message code="relatorio.processo.parametros.label.tipoprocesso" /></td>
					<td id="tipoProcesso"><form:select path="tipoProcesso" id="tipoProcesso" items="${tiposProcessos}" itemLabel="cdProcesso" itemValue="cdProcesso" /></td>
				</tr>
				<tr>
				
				<tr>
    				<td width="10%"><spring:message code="relatorio.processo.parametros.label.datainicial"/></td>
    				<td><form:input id="dataInicial" path="dataInicial" />
    				<form:errors path="dataInicial" /></td>
				</tr>

				<tr>
    				<td width="10%"><spring:message code="relatorio.processo.parametros.label.datafinal"/></td>
    				<td>
