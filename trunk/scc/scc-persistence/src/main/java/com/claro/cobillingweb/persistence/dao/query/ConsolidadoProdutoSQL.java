...
public class ConsolidadoProdutoSQL {
	...
	public static final String SQL_PRE = "SELECT " +
			...
			"	CDR.DT_REPASSE," +
			"	SUM(CDR.QT_TOTAL_MINUTOS_TARIFADOS) AS MI_DURACAO_TARIFADA," +
			"	SUM(CDR.VL_TOTAL_BRUTO) AS VL_BRUTO_CHAMADA," +
			...
			"FROM   SCC_CONSOLIDADO_PACOTES CDR, SCC_OPERADORA OP " +
			"WHERE CDR.CD_CSP = OP.CD_CSP ";
