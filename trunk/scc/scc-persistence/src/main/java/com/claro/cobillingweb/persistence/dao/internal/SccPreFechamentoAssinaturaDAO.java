...
public interface SccPreFechamentoAssinaturaDAO extends BasicDAO<SccPreFechamentoAssinatura> {
	...
	/**
	 * Pesquisa assinaturas de acordo com filtro informado. Aceita
	 * BasicDAO.GET_ALL_STRING para operadora Claro , operadora LD e Produto
	 * Pré-pago.
	 * 
	 * @param filtro
	 * @return
	...
	List<SccPreFechamentoAssinatura> pesquisaAssinaturasHolding(SccPreFechamentoAssinatura filtro) throws DAOException;
}
