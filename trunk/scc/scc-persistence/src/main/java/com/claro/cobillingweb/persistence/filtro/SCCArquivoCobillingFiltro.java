...
/**
 * Diversas telas do SCC iniciam com a pesquisa de arquivos. Esse TO é utilizado de forma genérica por todas 
 * essas pesquisas.
 *
 */
public class SCCArquivoCobillingFiltro implements Filtro {
