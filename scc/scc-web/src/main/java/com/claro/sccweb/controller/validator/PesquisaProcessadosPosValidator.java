...
public class PesquisaProcessadosPosValidator implements Validator {

	 
	public boolean supports(Class<?> clazz) {
		return clazz.equals(PesquisaProcessadosPosForm.class);
	}

	 
	public void validate(Object arg, Errors errors) {
		PesquisaProcessadosPosForm form = (PesquisaProcessadosPosForm)arg;
