...
public class RelatorioContabilTransicaoValidator implements Validator {

	 
	public boolean supports(Class<?> clazz) {		
		return clazz.equals(RelatorioContabilTransicaoForm.class);
	}

	 
	public void validate(Object arg, Errors errors) {
		RelatorioContabilTransicaoForm form = (RelatorioContabilTransicaoForm)arg;
