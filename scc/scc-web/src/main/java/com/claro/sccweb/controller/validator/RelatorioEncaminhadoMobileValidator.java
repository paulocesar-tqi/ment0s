 ...
 *
 */
public class RelatorioEncaminhadoMobileValidator implements Validator {

	@Override
	public boolean supports(Class<?> clazz) {

		return clazz.equals(RelatorioEncaminhadoMobileForm.class);
	}

	@Override
	public void validate(Object _form, Errors errors) {
		
		RelatorioEncaminhadoMobileForm form = (RelatorioEncaminhadoMobileForm)_form;
