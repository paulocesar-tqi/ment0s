 ...
 *
 */
public class ControleArquivoForm extends BaseForm  {
	
	private SccFiltroControleArquivo filtro = new SccFiltroControleArquivo();
	...
	public SccFiltroControleArquivo getFiltro() {
		return filtro;
	}

	public void setFiltro(SccFiltroControleArquivo filtro) {
		this.filtro = filtro;
	}
