...
$('#resultadosRecepcaoTransmissao').dataTable( {
	"aoColumns" : [{"fnRender": function(oObj,val)
        {	
			var seqArquivo = oObj.aData[0];
			return "<a href=/scc/user/pos/processados/sumario/status/arquivo/"+seqArquivo+".scc>"+seqArquivo+"</>";
	...
	"bProcessing": true,
	"bJQueryUI": true,
	"sAjaxSource": '/scc/user/pos/processados/pesquisa/arquivos/json.scc',
...
<tr><td>
<table  id="resultadosRecepcaoTransmissao" width="100%" border="1" cellspacing="0" cellpadding="0" >
<thead> 
<tr>
<th><spring:message code="pesquisa_processados_pos.seqArquivo"/></th>
<th><spring:message code="pesquisa_processados_pos.nome"/></th>
<th><spring:message code="pesquisa_processados_pos.operadoraClaro"/></th>
<th><spring:message code="pesquisa_processados_pos.operadoraExterna"/></th>
<th><spring:message code="pesquisa_processados_pos.dataProcessamentoClaro"/></th>
<th><spring:message code="pesquisa_processados_pos.dataReferencia"/></th>
