...
<div id="tabs">
	...
	<form:form modelAttribute="filtro" method="post" action="/scc/user/relatorio/arquivosNaoProcessados/execute.scc" id="form1">
		...
		<div id="tabs-1">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="filtroPesquisaTable">
				<tr>
    				<td width="10%"><spring:message code="relatorio.arquivos.nao.processados.label.datainicial"/></td>
    				<td><form:input id="dtInicial" path="dtInicial" />
    				<form:errors path="dtInicial" /></td>
				</tr>
				<tr>
    				<td width="10%"><spring:message code="relatorio.arquivos.nao.processados.label.datafinal"/></td>
    				<td>
				...
				<tr>
					<td width="20%"><spring:message code="relatorio.arquivos.nao.processados.label.nomedoarquivo"/>:</td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<display:table style="width:90%" name="sessionScope._DISPLAY_TAG_SPACE_1" pagesize="20" id="arquivosNaoProcessados" requestURI="/scc/user/relatorio/arquivosNaoProcessados/tab1.scc" class="ui-state-default">
							<display:column property="noArquivoRetorno" title="Nome do Arquivo"/>
							...
							<display:column property="dtRecebimento" title="Data de Recebimento"/>
						</display:table>
					</td>
				</tr>
			</table>
