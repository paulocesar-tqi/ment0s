				...
				<tr>
					<td>
						<display:table style="width:90%" name="sessionScope._DISPLAY_TAG_SPACE_1" pagesize="20" id="repasses" requestURI="/scc/user/relatorio/chamadas/refaturamento/tab1.scc" class="ui-state-default">
							<display:column property="numeroA" title="Número de A"/>
							<display:column property="numeroB" title="Número de B"/>
							...
							<display:column property="codigoCriticaInicial" title="Código da Crítica Inicial"/>
