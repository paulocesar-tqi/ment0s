...
<div id="tabs">
	...
	<form:form modelAttribute="filtro" method="post" action="/scc/user/relatorio/assexuados/execute.scc" id="form1">
		...
		<div id="tabs-1">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="filtroPesquisaTable">
				<tr>
    				<td width="10%"><spring:message code="relatorio.assexuados.label.datainicial"/></td>
    				<td><form:input id="dtInicial" path="dtInicial" />
    				<form:errors path="dtInicial" /></td>
				</tr>
				<tr>
    				<td width="10%"><spring:message code="relatorio.assexuados.label.datafinal"/></td>
    				<td>
				...
				<tr>
					<td width="20%"><spring:message code="relatorio.assexuados.label.nomedoarquivo"/>:</td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<display:table style="width:90%" name="sessionScope._DISPLAY_TAG_SPACE_1" pagesize="20" id="assexuados" requestURI="/scc/user/relatorio/assexuados/tab1.scc" class="ui-state-default">
							<display:column property="numeroDeA" title="Número de A"/>
							...
							<display:column property="cdErroReciclagem" title="Código de Erro de Reciclagem"/>
