	...
	<form:form modelAttribute="filtro" method="post" action="execute.scc" id="form1">
		...
		<div id="tabs-1">
			...
			<c:if test="${!empty sessionScope._DISPLAY_TAG_SPACE_1}">
				<table  width="100%" border="0" cellspacing="0" cellpadding="0" >
					 <tr><td>                            
						<display:table style="width:90%"  name="sessionScope._DISPLAY_TAG_SPACE_1"   pagesize="20"  id="repasses" requestURI="/scc/user/admin/grupo/tab1.scc" class="ui-state-default">
						<display:column property="row.descricao" title="Grupo" />
		...
		<div id="tabs-2" style="height: 500px;">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" >
				...
				<tr>
					...
					<td>
						<form:input path="entity.descricao" id="descricao" size="61" maxlength="60"/><form:errors path="entity.descricao"/>
					</td>
				</tr>
			</table>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
