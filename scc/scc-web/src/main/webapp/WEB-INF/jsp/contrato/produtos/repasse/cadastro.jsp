...
<display:column property="CDRCobranca" title="CDR Cobrança" />
<display:column property="formaCobranca" title="Forma Cobrança" />
<display:column property="formaPagamento" title="Forma Pagamento" />
<display:column property="formaRepasse" title="FormaRepasse" />
<display:column property="prestacaoServicos" title="Prestacao de Serviços" />
<display:column property="calculoCobilling" title="Cálculo Cobilling" />
<display:column property="calculoRepasse" title="Cálculo Repasse" />
...
<tr><td width="15%">Cobrança de Prestação de Serviços:</td>
<td>
<form:checkbox path="entity.fgCobrarPrestacaoServico" value="S" label="Sim" id="fgCobrarPrestacaoServico"/>
<form:checkbox path="entity.fgCobrarPrestacaoServico" value="N" label="Não" id="fgCobrarPrestacaoServico"/>
</td></tr>
