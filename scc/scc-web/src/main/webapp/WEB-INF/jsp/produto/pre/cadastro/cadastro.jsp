...
<form:form modelAttribute="filtro" method="post" action="/scc/user/produto/pre/cadastro/execute.scc" id="form1">
<form:hidden path="operacao" id="operacao"/>
<form:hidden path="itemSelecionado" id="itemSelecionado"/>
<form:hidden path="entity.dtCriacao" id="dtCriacao"/>
<form:hidden path="entity.cdProdutoPrepago" id="cdProdutoPrepago"/>
<div id="tabs-1">
...
<table  width="100%" border="0" cellspacing="0" cellpadding="0" >
 <tr><td>                            
<display:table style="width:90%"  name="sessionScope._DISPLAY_TAG_SPACE_1"   pagesize="20"  id="repasses" requestURI="/scc/user/produto/pre/cadastro/tab1.scc" class="ui-state-default">
<display:column property="produto" title="Produto" />
<display:column property="prestacaoServico" title="Tipo do Produto" />
...
<td>
<form:input path="entity.noProdutoPrepago" id="noProdutoPrepago" size="52" maxlength="50"/><form:errors path="entity.noProdutoPrepago"/>
</td></tr>

<tr><td width="15%">Prestação de Serviços:</td>
<td>
<form:checkbox path="entity.fgCobrarPrestacaoServico" value="S"/>
</td></tr>
